...
public class WisataAdapterDetail extends RecyclerView.Adapter<WisataAdapterDetail.MyHolder>{


    private ArrayList<WisataModel> listData;
    private Context context;

    public WisataAdapterDetail(ArrayList<WisataModel> listData, Context context) {
    ...
    @Override
    public WisataAdapterDetail.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v=  LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_wisata_2, parent, false);
        MyHolder holder = new MyHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(WisataAdapterDetail.MyHolder holder, final int position) {
